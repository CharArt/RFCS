...
import com.wb.amr.robot.flotilla.control.system.tools.astar.ConverterFromDxfPointToAStartNode;
...
public class ConverterDxfPointToAStartNodeTest {
    ...
    public void converterWithValidMap() throws IOException {
        ...
        ConverterFromDxfPointToAStartNode converter = new ConverterFromDxfPointToAStartNode(points);
