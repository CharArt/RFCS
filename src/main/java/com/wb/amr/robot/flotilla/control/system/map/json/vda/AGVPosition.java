...
public class AGVPosition extends BasicEntity {
    private static final Logger LOGGER = LogManager.getLogger(AGVPosition.class.getName());
    ...
    private Double localizationScore = 0.0;
